        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader className="text-center">
                    ...
                    <DialogTitle className="text-2xl font-bold">Welcome to SupplyGuard AI</DialogTitle>
                    <DialogDescription className="text-muted-foreground">
                        Sign in to start securing your codebase with AI-powered vulnerability detection
                    </DialogDescription>
                </DialogHeader>
